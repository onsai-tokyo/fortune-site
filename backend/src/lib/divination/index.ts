...
export const SUKUYO_ORDER = ["婁","胃","昴","畢","觜","参","井","鬼","柳","星","張","翼","軫","角","亢","氐","房","心","尾","箕","斗","女","虚","危","室","壁","奎"]
export const NAYIN = [
  "海中金","海中金","炉中火","炉中火","大林木","大林木","路傍土","路傍土","剣鋒金","剣鋒金","山頭火","山頭火",
  "澗下水","澗下水","城頭土","城頭土","白鑞金","白鑞金","楊柳木","楊柳木","井泉水","井泉水","屋上土","屋上土",
  "霹靂火","霹靂火","松柏木","松柏木","長流水","長流水","沙中金","沙中金","山下火","山下火","平地木","平地木",
  "壁上土","壁上土","金箔金","金箔金","覆燈火","覆燈火","天河水","天河水","大駅土","大駅土","釵釧金","釵釧金",
  "桑柘木","桑柘木","大渓水","大渓水","沙中土","沙中土","天上火","天上火","石榴木","石榴木","大海水","大海水",
] as const
  ...
  const annual: AnnualTiming[] = yun.getDaYun(8).flatMap((period: any) => period.getLiuNian())
    ...
    .map((item: any) => {
      ...
      return {
        ...
        ageRange: `${item.getYear() - year - 1}〜${item.getYear() - year}歳`,
