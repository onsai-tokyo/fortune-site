...
test('詳細鑑定に恋愛・結婚・仕事と過去・未来の傾向を含める', () => {
  ...
  for (const heading of ['算命学詳細', '紫微斗数', '仕事・適職', '恋愛', '結婚', '過去の傾向', '現在から未来', '大運', '婚期の候補', '年運', '宿曜詳細', '九星気学詳細', '数秘術詳細', '納音詳細', '全占術統合鑑定', '全占術統合 — 才能', '全占術統合 — 恋愛', '全占術統合 — 現在', '全占術統合 — 注意点']) {
