...
const TOC_ITEMS = [
  ...
  { num: '4', title: 'この人固有の資質・恋愛パターン' },
  { num: '5', title: '運命・人生で果たしやすい役割' },
  { num: '6', title: '仕事の傾向・適した環境' },
  { num: '7', title: '恋愛・結婚の傾向' },
  { num: '8', title: '友人・人間関係の傾向' },
  { num: '9', title: '複数の時間運が重なる年' },
  { num: '10', title: '人生への具体的なアドバイス' },
]
...
const FAQS = [
  ...
  { q: '同じ出生データを入れると、同じ結果になりますか？', a: 'はい。同じ出生データなら、同じ計算結果から読み解きます。' },
