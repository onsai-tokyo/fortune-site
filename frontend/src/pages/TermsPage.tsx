        ...
        <div className="glass-card p-8 space-y-8">
          ...
          <section>
            ...
            <div className="text-white/70 text-sm space-y-2">
              ...
              <p>月額プランは解約されるまで毎月自動更新されます。ユーザーは契約管理画面からいつでも解約でき、解約後も現在の請求期間が終了するまでは利用できます。</p>
              <p>デジタルサービスの性質上、提供開始後の返金は原則として行いません。ただし当社のシステム不具合によりサービスを利用できなかった場合は個別に確認します。</p>
