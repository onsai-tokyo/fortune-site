...
const routes = [
  { path: 'feature/self', title: '自己分析｜強み・適職・人生の転換期を命式で診断', description: '生年月日から複数占術を計算し、性格の本質、強み・弱み、適職、人生の転換期を整理します。' },
  { path: 'feature/compat', title: '無料の相性診断｜生年月日で恋愛・仕事の相性を鑑定', description: '2人の生年月日から、恋愛や仕事の相性、価値観、関係を良くするヒントを複数の占術で読み解きます。' },
  { path: 'feature/marriage', title: '結婚相性占い｜生年月日で夫婦関係・結婚生活を診断', description: '2人の生年月日から結婚相性、夫婦の力関係、結婚生活を円満にするヒントを複数占術で読み解きます。' },
  ...
  { path: 'privacy', title: 'プライバシーポリシー', description: 'Fate Labにおける個人情報の取り扱いについて説明します。' },
  { path: 'terms', title: '利用規約', description: 'Fate Labのサービス利用条件について説明します。' },
  { path: 'tokushohou', title: '特定商取引法に基づく表記', description: 'Fate Labの特定商取引法に基づく表記です。' },
];
...
function pageHtml(template, route) {
  ...
  const title = route.path.startsWith('feature/') ? route.title : `${route.title}｜Fate Lab`;
